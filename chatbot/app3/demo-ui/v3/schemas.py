...
definitions = {'definitions': {'BotMessage': {'type': 'object', 'properties': {'username': {'type': 'string', 'example': 'Jack Kelly'}, 'answer': {'type': 'string', 'example': 'Hi I am at your command'}}, 'required': ['answer']}}, 'parameters': {}}

validators = {
    ('chatmessage', 'GET'): {'args': {'required': ['userMessage', 'userName'], 'properties': {'userMessage': {'description': 'query message from the user. Eg. Show me all the cinemas around me?', 'type': 'string'}, 'userName': {'description': 'User name', 'type': 'string'}}}},
}

filters = {
    ('chatmessage', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/BotMessage'}}, 500: {'headers': None, 'schema': None}},
}
